...
const columnAccessByRole: ColumnAccessByRoleProps = {
  admin: [
    ...
    },
    {
      ...
      width: "2xl:min-w-[240px]",
    },
    { key: "client", label: "Client", width: "2xl:min-w-[120px]" },
    ...
    { key: "paid", label: "Paid", width: "2xl:min-w-[140px]" },
    { key: "outstanding", label: "Outstanding", width: "2xl:min-w-[140px]" },
    { key: "progress", label: "Progress", width: "2xl:min-w-[180px]" },
    { key: "pm", label: "PM", width: "2xl:min-w-[140px]" },
    { key: "actions", label: "", width: "2xl:min-w-[60px]" },
  ],
  pm: [
    {
      key: "date_quoted",
